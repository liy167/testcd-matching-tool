...
def check_required_env_vars():
    ...
    if missing_vars:
        error_msg = (
            ...
            f"  $env:EXCEL_PATH = 'Z:\\projects\\utility\\metadata\\SDTM Terminology.xls'\n"
            f"  $env:MAPPING_FILE = 'Z:\\projects\\utility\\macros\\09_metadata\\TEST_TESTCD_mapping.xlsx'\n"
            f"  $env:CACHE_DIR = 'Z:\\projects\\utility\\metadata\\testcd_embedding'\n"
            f"\n"
            f"设置方法（Linux/Mac）：\n"
